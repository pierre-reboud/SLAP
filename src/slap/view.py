...
class View:
    ...
    def __init__(self, pose : np.ndarray, len_point_ids: int):
        ...
        self._point_ids : np.ndarray = np.zeros((1, len_point_ids), np.uint32)#List[int] = []
        # View id
